...
<div class="d-flex flex-column min-vh-100">
  ...
  <ul class="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="?page=logout" onclick="(function(e){e.preventDefault(); AppModal.confirm('Are you sure you want to logout?','localhost says').then(function(ok){ if(ok){ window.location.href='?page=logout'; } });})(event); return false;">
